...
from Router import get_class_info
...
def face_recognition(face, representations=None, class_info=None):
    if representations is None:
        ...
        df = DeepFace.custom(img_path=face, representations=representations, enforce_detection=False,
                             model_name="Facenet")
    ...
    if ret and True:
        ...
        for box in boxes:
            try:
                ...
                orig_image = cv2.putText(orig_image, name, (box[0], box[1]), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0),
                                         2)
